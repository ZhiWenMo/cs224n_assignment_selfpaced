    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            U_r = tf.get_variable(initializer=tf.contrib.layers.xavier_initializer(),
                                 shape=[self.state_size,self._state_size],
                                 name='U_r')
            W_r = tf.get_variable(initializer=tf.contrib.layers.xavier_initializer(),
                                 shape=[self.input_size,self._state_size],
                                 name='W_r')
            b_r = tf.get_variable(initializer=tf.contrib.layers.xavier_initializer(),
            ...
            W_z = tf.get_variable(initializer=tf.contrib.layers.xavier_initializer(),
                                 shape=[self.input_size,self._state_size],
                                 name='W_z')
            b_z = tf.get_variable(initializer=tf.contrib.layers.xavier_initializer(),
                                 shape=[self._state_size],
                                 name='b_z')
            ...
            W_o = tf.get_variable(initializer=tf.contrib.layers.xavier_initializer(),
                                 shape=[self.input_size,self._state_size],
                                 name='W_o')
            b_o = tf.get_variable(initializer=tf.contrib.layers.xavier_initializer(),
                                 shape=[self._state_size],
                                 name='b_o')
